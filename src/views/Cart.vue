<template>
  <div :class="{ 'app-default': !isActive, 'loadings': isActive }">
    <span class="span"></span>
    <span class="span"></span>
    <span class="span"></span>
    <span class="span"></span>
  </div>
  <div :class="{ 'content': !isActive, 'set': isActive }">
    <div v-if="cart && cart.length" class="container container--cart">
      <div class="cart">
        <div class="cart__top">
          ...
          <div @click="cartDelet" class="cart__clear">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
        ...
        <div class="cart__bottom">
          <div class="cart__bottom-details">
            <span>
              Всего пицц: <b>{{ store.state.totalCount }} шт.</b>
            </span>
            <span>
              Сумма заказа: <b>{{ store.state.totalPrice }} ₽</b>
            </span>
          </div>
          <div class="cart__bottom-buttons">
            ...
            <div @click="test" class="button pay-btn">
...
const RemoveCount = (index) => {
  if (cart.value[index].counter > 1) {
    cart.value[index].counter = cart.value[index].counter - 1;
    store.commit("TOTAL_COUNT_PRICE", cart.value);
    localStorage.setItem("cart", JSON.stringify(cart.value));
  }
};
